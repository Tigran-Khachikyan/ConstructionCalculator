 ...
 * Use the [ShapePagerFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ShapePagerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ShapePagerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ShapePagerFragment().apply {
